...
func newSAP() *SAP {
	return &SAP{
		...
		user:            getEnv("SAP_USER", "XXXXXXXXXXX"),
		pass:            getEnv("SAP_PASS", "XXXXXXXXXXX"),
		tokenRefreshURL: getEnv("SAP_TOKEN_REFRESH_URL", "http://XXX.XX.XX.XXX:8080/sap/opu/odata/sap/API_PURCHASE_REQUISITION_SRV/"),
