...
import (
	"fmt"
	sap_api_caller "sap-api-integrations-purchase-requisition-creates-rmq-kube/SAP_API_Caller"
	"sap-api-integrations-purchase-requisition-creates-rmq-kube/SAP_API_Caller/requests"
	sap_api_input_reader "sap-api-integrations-purchase-requisition-creates-rmq-kube/SAP_API_Input_Reader"
	"sap-api-integrations-purchase-requisition-creates-rmq-kube/config"
...
func callProcess(caller *sap_api_caller.SAPAPICaller, msg rabbitmq.RabbitmqMessage) (err error) {
	...
	caller.AsyncPostPurchaseRequisition(headerItem, accepter)
	return nil
}
